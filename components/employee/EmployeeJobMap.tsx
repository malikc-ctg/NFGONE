...
export default function EmployeeJobMap({ jobLat, jobLng, jobAddress }: EmployeeJobMapProps) {
  ...
  useEffect(() => {
    ...
    // Get employee's current location and draw route
