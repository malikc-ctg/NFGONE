  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <div className="p-5 flex flex-col items-center justify-center flex-1 text-center">
        ...
        <div className="flex items-center justify-center gap-1 mt-1 mb-4 text-amber-500">
        ...
        <button className="w-full bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 font-medium py-2 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm">
